...
export default function WarehouseEdit() {
    ...
    useEffect(() => {
        const warehouse = new fetchDataService(getUrl(`/api/admin/warehouse/${id}`));
        warehouse.fetchData()
        .then(response => {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(`http://127.0.0.1:8000/api/admin/warehouse/update/${id}`, {
            name
        })
            .then(response => {
    ...
    const handleDelete = async () => {
            await axios.delete(`http://127.0.0.1:8000/api/admin/warehouse/delete/${id}`)
            .then(response => {
                console.log(response);
                navigate(-1);
            })
        ...
        <>
            <div className="pb-4 mb-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-medium">Edit Unit</h1>
                    ...
                    <div className="flex space-x-4">
                        <div className="space-y-4 flex-1 flex-col">
                            <div className="group flex items-center">
                                <label htmlFor="kode" className="w-64">Nama Unit</label>
                                <input 
