    ...
    return (
        <aside className="w-64 h-full bg-blue-500">
            ...
            <ul className="font-medium p-3 space-y-2">
                ...
                <li>
                    <button className="w-full flex item-center text-white rounded hover:bg-blue-600 transition duration-300 ease-in-out p-2" onClick={isOpen ? toggleDropdown : undefined}>
