            ...
            <div className="border-b-2 px-6 pt-6">
                <div className="flex items-center justify-between">
                    ...
                    <div className="relative">
                        <button className="p-1 px-4 bg-blue-500 text-white rounded flex items-center font-medium" onClick={toggleDropdown}>
                            <span>Action</span>
                            <span className="p-2">    
                        ...
                        {isDropdownOpen && (
                            <div className="absolute mt-1 w-56 right-0 bg-white rounded-md border border-gray-300">
                                <ul>
                                    <Link to="/tambah_barang" className="flex item-center hover:bg-gray-100 transition duration-300 ease-in-out p-2 px-3">
                                        <span>Tambah Barang</span>
                                    </Link>
                                    <Link to="/tambah_gudang" className="flex item-center hover:bg-gray-100 transition duration-300 ease-in-out p-2 px-3">
